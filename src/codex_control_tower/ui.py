...
class App(QWidget):
    ...
    def update_tabs(self):
        accents={"monitor":"#78a7e8","todo":"#e0a45f","learn":"#9b8bd7","system":"#65b395"}; active=f"QPushButton{{padding:6px 12px;background:{accents.get(self.view_mode,'#78a7e8')};color:white;border:0;border-radius:7px;font-weight:700}}"
    ...
    def window_panel(self):
        p=QFrame(); p.setObjectName("windowPanel"); p.setStyleSheet("QFrame#windowPanel{background:#f7faff;border:1px solid #e2ecf8;border-radius:11px} QFrame#windowPanel QLabel{background:transparent;border:0}"); v=QVBoxLayout(p); v.setSpacing(8)
