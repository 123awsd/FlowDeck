...
“等待学习”会按 3、5、10 或 20 分钟生成有边界的机器人前沿学习包。内容混合最新 arXiv `cs.RO` 论文和 Google DeepMind、Boston Dynamics、NVIDIA Developer 等官方频道的机器人 Demo；卡片保留发布日期、来源和原始链接。DeepSeek 仅负责生成“解决什么、相对已有工作的增量、为什么值得看”的短摘要，API 失败时会自动回退到原始描述。
